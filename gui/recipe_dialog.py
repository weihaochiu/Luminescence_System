...
class RecipeManagerDialog(
    ...
    def _build_ui(self) -> None:
        ...
        self.tabs.addTab(self._build_polarity_tab(), "2 極性確認")
        self.tabs.addTab(self._build_dark_iv_tab(), "3 Dark I–V")
        self.tabs.addTab(self._build_camera_tab(), "4 相機／非 HDR 預設")
        self.tabs.addTab(self._build_el_tab(), "5 EL 點位")
        self.tabs.addTab(self._build_dark_frame_tab(), "6 Dark Frames")
        self.tabs.addTab(self._build_safety_tab(), "7 安全／SMU")
        self.tabs.addTab(self._build_output_tab(), "8 輸出")
        ...
        footer = QHBoxLayout()
        footer.addWidget(QLabel("極性確認與 Dark I–V 為必做；只有啟用且通過驗證的 Recipe 會顯示在主畫面。"))
        footer.addStretch()
